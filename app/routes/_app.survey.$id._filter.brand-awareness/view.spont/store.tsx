...
const storeUtil = utilCreateWidget({
    name: "SurveyIdBrandAwernessViewSpont",
    useInitStore: () => {
        ...
        const ext = useToMobExt({
            stat: trpcUse.surveyIdBrandAwarenessViewSpontStat.useQuery(store.apiQuery, {
                initialData: {
                    items: [],
                    totalCount: 0
                }
        ...
        useEffect(() => {
            app.addAiData("surveyBrandSpont", store.aiData);
        }, [store.aiData])
...
export const hocViewSpont = storeUtil.hocComp;
export const useViewSpontStore = storeUtil.useStore;