...
const storeUtil = utilCreateWidget({
    ...
    useInitStore: (opt) => {
        ...
        const ext = useToMobExt({
            list: trpcUse.surveyIdRespondentList.useQuery({
...
export const hocSurveyIdRespondent = storeUtil.hocComp;
export const useSurveyIdRespondentStore = storeUtil.useStore;
